...
.btn:hover:not(:disabled) { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(124, 58, 237, 0.35); }
...
.link { color: var(--vp-c-brand-1, #a78bfa); }
...
.src {
  display: inline-block; font-size: 0.8rem; color: #a78bfa; text-decoration: none;
